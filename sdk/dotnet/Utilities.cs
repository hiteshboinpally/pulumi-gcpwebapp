...
namespace Pulumi.Gcpwebapp
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Gcpwebapp.version.txt");
    ...
    internal sealed class GcpwebappResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public GcpwebappResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
